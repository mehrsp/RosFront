import { Component, ElementRef, Renderer2, ViewChild, OnInit, NgZone } from '@angular/core';
...
@Component({
  selector: 'app-hss-layout',
  templateUrl: './hss-layout.component.html',
  styleUrls: ['./hss-layout.component.css']
})
export class HssLayoutComponent implements OnInit {
